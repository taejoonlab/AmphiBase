...
import sys
import gzip
from MODtree import get_sp_info, get_HS_prot2names, get_prot2names

## Input parameter: 'aa.fasta/' directory 
## You can download it from  http://www.treefam.org/static/download/treefam9.fa.tar.gz
